...
def filtering_extreme_values(v): 
...
def high_contrast(image):
    ...
    b_hc=filtering_extreme_values(b)
    g_hc=filtering_extreme_values(g)
    r_hc=filtering_extreme_values(r)

    image = cv2.merge((b_hc,g_hc,r_hc))
